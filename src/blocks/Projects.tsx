            ...
            {projects.map((project) => (
              ...
              >
                <div className="space-y-4">
                  <h3 className={`text-3xl sm:text-4xl font-bold text-${project.accentColor}`}>
                    {project.name}
                  </h3>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {project.features.map((feature, index) => (
                      ...
                      >
                        <div className={`w-2 h-2 rounded-full bg-${project.accentColor}`} />
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
                ...
                >
                  <motion.a
                    ...
                    className={`px-6 py-3 bg-${project.accentColor} text-white font-semibold rounded-lg hover:bg-${project.accentColor.replace('500', '600')} transition-colors`}
                    whileHover={{
                      scale: 1.02,
                    }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`px-6 py-3 border-2 border-${project.accentColor} text-neutral-300 font-semibold rounded-lg hover:bg-neutral-700 hover:text-white transition-colors`}
                    whileHover={{
                      scale: 1.02,
                    }}
                    whileTap={{ scale: 0.98 }}
